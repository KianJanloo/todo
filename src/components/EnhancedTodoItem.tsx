      ...
      {isEditing ? (
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start gap-3">
            ...
            >
              {todo.completed && <HiCheck className="w-3 h-3 sm:w-4 sm:h-4" />}
            </button>
            ...
            <div className="flex-1 min-w-0">
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 sm:gap-3">
                ...
                <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
                  ...
                  {/* Category badge */}
                  <span
                    className={`px-2 py-1 rounded-full text-xs font-medium text-white flex items-center gap-1 ${categoryInfo?.color}`}
                  >
                    {categoryInfo?.icon && (
                ...
                {todo.dueDate && (
                  <span
                    className={`flex items-center gap-1 ${
                      isOverdue ? "text-red-500 font-medium" : isDark ? "text-gray-400" : "text-gray-500"
                    }`}
                  >
            ...
            <div className="flex items-center gap-1 flex-shrink-0">
              <button
                ...
                className={`p-1.5 sm:p-2 text-blue-500 rounded-lg transition-colors ${
              ...
              <button
                ...
                className={`p-1.5 sm:p-2 text-orange-500 rounded-lg transition-colors ${
                  isDark ? "hover:bg-orange-900/20" : "hover:bg-orange-50"
                }`}
              ...
              <button
                ...
                className={`p-1.5 sm:p-2 text-red-500 rounded-lg transition-colors ${
